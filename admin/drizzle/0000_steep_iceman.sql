...
CREATE TABLE "activities" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "activities_deadline_before_start" CHECK ("activities"."registration_deadline" < "activities"."start_time")
);
--> statement-breakpoint
...
ALTER TABLE "circle_follows" ADD CONSTRAINT "circle_follows_circle_id_circles_id_fk" FOREIGN KEY ("circle_id") REFERENCES "public"."circles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "circle_follows" ADD CONSTRAINT "circle_follows_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "circle_follows_circle_user_idx" ON "circle_follows" USING btree ("circle_id","user_id");--> statement-breakpoint
CREATE INDEX "circle_follows_user_idx" ON "circle_follows" USING btree ("user_id");--> statement-breakpoint
